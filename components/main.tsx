...
export default function Main() {
  return (
    <main className="grid grid-cols-1 md:grid-cols-2 md:px-4 md:pt-20 max-w-[80%] m-auto">
      ...
      <section>
        <div className="p-6 md:p-0 md:mb-6">
        ...
        <form action="" className="px-6 py-2 space-y-4 md:p-0">
